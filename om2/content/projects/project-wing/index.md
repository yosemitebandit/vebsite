...
[extra]
thumbnail = "projects/project-wing/vehicles.png"
+++
...
{{ resize_image(path="projects/project-wing/egg-prototype.png", width=500, height=500, op="fit_width") }}
...
{{ resize_image(path="projects/project-wing/vehicles.png", width=500, height=500, op="fit_width") }}
