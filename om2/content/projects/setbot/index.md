...
[extra]
thumbnail = "projects/setbot/setbot-by-the-window.jpg"
+++
...
{{ resize_image(path="projects/setbot/setbot-by-the-window.jpg", width=500, height=500, op="fit_width") }}
...
{{ resize_image(path="projects/setbot/setbot-game.png", width=500, height=500, op="fit_width") }}
...
The full model image is here:

{{ resize_image(path="projects/setbot/setbot-model.png", width=500, height=500, op="fit_width") }}
...
{{ resize_image(path="projects/setbot/setbot-example-3-red-striped-oval.png", width=500, height=500, op="fit_width") }}
