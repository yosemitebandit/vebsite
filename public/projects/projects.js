    ...
    , "history": [
        ...
        },
        {
            ...
            , projects: [
                {
                    name: "ReDream"
                    , blurb: "reliving dreams through archival footage"
                    , where: "San Francisco"
                    , tags: ["small", "favorite"]
                    , expound: "I helped build <a href='http://redream.us'>redream.us</a> during a hackathon hosted by <a href='http://gaffta.org'>GAFFTA</a> and the Tribeca Institute.  Our site takes written memories of dreams and pieces together video montages that evoke the nocturnal experience.</p><p>All of the site's videos are listed by <a href='https://twitter.com/redream_us'>@redream_us</a>, so check there to watch the dreams of others.  And make sure to listen to the mixed audio in each compilation &ndash; that's often my favorite part.</p><p>This team was really, really great &ndash; everyone's listed <a href='http://redream.us/about'>here</a>.  We put our code on <a href='https://github.com/yosemitebandit/redream'>github</a>, and the readme goes through more of the technical specifics if you're curious.</p>"
                    , photos: {
                        thumb: "https://s3.amazonaws.com/yb-img/redream.png"
                    }
                }
                , {
                    name: "Target Accrual"
